==============================================
Chile - E-invoicing (Fix multicompany CAF DTE)
==============================================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module fixes upload CAF files in               !!
...
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fl10n--cl-lightgray.png?logo=github
    :target: https://github.com/calyx-servicios/l10n-cl
    :alt: calyx-servicios/multi-store.git

|badge1| |badge2| |badge3|

This module fixes upload CAF files in multicompany environment.
...
* Find module "l10n_cl_edi_fix_multicompany"
...
This module is part of the `Account Payment <https://github.com/calyx-servicios/l10n_cl>`_ project on Github.